      ...
      answer: (
        <ol className="list-decimal list-inside space-y-2 mt-1">
          ...
          <li>
            ...
            <Link href="/calibragem" className="text-aqua-400 hover:underline">Calibragem</Link>.
          </li>
          <li>
    ...
    <div className="min-h-screen bg-dark-bg">
      <header className="bg-dark-card border-b border-dark-border shadow-lg">
        <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-dark-textSecondary mt-1">
            Manual de uso do HIDROWAVE — como operar o sistema com segurança
          </p>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <Link
            href="/automacao"
            className="bg-dark-card border border-dark-border rounded-lg shadow-lg p-6 hover:shadow-aqua-500/20 hover:border-aqua-500/50 transition-all"
          >
