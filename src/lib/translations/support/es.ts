    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          'En el firmware actual, las señales del transmisor (cuando se configura como 0–5 V analógico) se convierten en `ph`, `ec` (µS/cm) y `temperature` dentro de `hydro_measurements`; el XKR-25 se normaliza a `water_level_ok` para interlocks y reglas.',
        ...
        sensorCards: [
          {
            ...
            subsections: [
              ...
              {
                title: 'Qué ver en serial/MQTT',
                bullets: ['`hydro_measurements.ec` (µS/cm).', 'Cuando Auto EC está activo: `ec_operation_state` alterna entre dosing/recirculación.'],
              },
            ],
          },
        ],
