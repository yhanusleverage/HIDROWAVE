    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          'No firmware atual, os sinais do transmissor (quando configurado como 0–5 V analógico) viram `ph`, `ec` (µS/cm) e `temperature` em `hydro_measurements`; o XKR-25 vira `water_level_ok` para interlocks e regras.',
        ...
        sensorCards: [
          {
            ...
            subsections: [
              ...
              {
                title: 'O que ver no serial/MQTT',
                bullets: ['`hydro_measurements.ec` (µS/cm).', 'Quando Auto EC estiver ativo: `ec_operation_state` muda entre dosing/recirculating.'],
              },
            ],
          },
        ],
