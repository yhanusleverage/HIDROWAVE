    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          'In the current firmware, transmitter signals (when configured as 0–5 V analog) become `ph`, `ec` (µS/cm) and `temperature` inside `hydro_measurements`; the XKR-25 becomes `water_level_ok` for interlocks and rules.',
        ...
        sensorCards: [
          {
            ...
            subsections: [
              ...
              {
                title: 'What to see in serial/MQTT',
                bullets: ['`hydro_measurements.ec` (µS/cm).', 'When Auto EC is active: `ec_operation_state` toggles between dosing/recirculating.'],
              },
            ],
          },
        ],
