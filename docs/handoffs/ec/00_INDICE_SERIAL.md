...
| Transport | [AUTO_EC_PH_CONFIG_TRANSPORT_HANDOFF.md](AUTO_EC_PH_CONFIG_TRANSPORT_HANDOFF.md) | Config Auto EC/pH MQTT retained; GET fallback | Fase B MQTT | **Código 27/08** — [ACL+mapa](../../../../ESP-HIDROWAVE-main/docs/mqtt/ACL_MAPA_FUNCIONALIDADES_27AGO2026.md) |
